...
interface MediaLibraryProps {
  ...
  selectedVideoClipId?: string | null; // ID of the source video for the selected timeline clip
}
    ...
    >
      ...
      {clips.length === 0 ? (
        ...
        <div className="space-y-3">
          {clips.map((clip) => {
            const isUsedBySelectedClip = clip.id === selectedVideoClipId;
            ...
            return (
              <div
                ...
                className={`rounded-lg p-3 cursor-grab active:cursor-grabbing transition-colors bg-gray-700 hover:bg-gray-600 ${
                  isUsedBySelectedClip
